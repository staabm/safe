...
return static function (RectorConfig $rectorConfig): void {
    $rectorConfig->ruleWithConfiguration(
        ...
        [            'apache_getenv' => 'Safe\apache_getenv',
            ...
            'ldap_exop_sync' => 'Safe\ldap_exop_sync',
            ...
            'link' => 'Safe\link',
            'litespeed_finish_request' => 'Safe\litespeed_finish_request',
            'lstat' => 'Safe\lstat',
            ...
            'pcntl_unshare' => 'Safe\pcntl_unshare',
            'pfsockopen' => 'Safe\pfsockopen',
            'pg_cancel_query' => 'Safe\pg_cancel_query',
            'pg_change_password' => 'Safe\pg_change_password',
            ...
            'pg_escape_identifier' => 'Safe\pg_escape_identifier',
            'pg_escape_literal' => 'Safe\pg_escape_literal',
            ...
            'pg_set_error_verbosity' => 'Safe\pg_set_error_verbosity',
            ...
            'ssh2_auth_pubkey' => 'Safe\ssh2_auth_pubkey',
            ...
            'ssh2_sftp_lstat' => 'Safe\ssh2_sftp_lstat',
            'ssh2_sftp_mkdir' => 'Safe\ssh2_sftp_mkdir',
            'ssh2_sftp_readlink' => 'Safe\ssh2_sftp_readlink',
            'ssh2_sftp_realpath' => 'Safe\ssh2_sftp_realpath',
            'ssh2_sftp_rename' => 'Safe\ssh2_sftp_rename',
            'ssh2_sftp_rmdir' => 'Safe\ssh2_sftp_rmdir',
            'ssh2_sftp_stat' => 'Safe\ssh2_sftp_stat',
