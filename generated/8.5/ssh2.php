 ...
 *
 */
function ssh2_auth_pubkey($session, string $username, string $pubkey, string $privkey, ?string $passphrase = null): void
{
    error_clear_last();
    if ($passphrase !== null) {
        $safeResult = \ssh2_auth_pubkey($session, $username, $pubkey, $privkey, $passphrase);
    } else {
        $safeResult = \ssh2_auth_pubkey($session, $username, $pubkey, $privkey);
    }
    if ($safeResult === false) {
        throw Ssh2Exception::createFromPhpError();
    }
...
{
    error_clear_last();
    $safeResult = \ssh2_sftp_lstat($sftp, $path);
    if ($safeResult === false) {
        throw Ssh2Exception::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \ssh2_sftp_readlink($sftp, $link);
    if ($safeResult === false) {
        throw Ssh2Exception::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \ssh2_sftp_realpath($sftp, $filename);
    if ($safeResult === false) {
        throw Ssh2Exception::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \ssh2_sftp_stat($sftp, $path);
    if ($safeResult === false) {
        throw Ssh2Exception::createFromPhpError();
    }
    return $safeResult;
